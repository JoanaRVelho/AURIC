...
/**
 * Portrait Camera Preview is a {@link android.view.SurfaceView} and
...
public class PortraitCameraPreview extends SurfaceView implements
	...
	/**
	 * Gets camera display orientation in degrees
	 * 
	 * @param windowManager
	 * @return camera display orientation in degrees
	 */
	private static int getCameraDisplayOrientation(WindowManager windowManager) {
