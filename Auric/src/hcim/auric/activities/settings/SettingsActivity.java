...
import hcim.auric.accessibility.AuricAccessibilityService;
...
public class SettingsActivity extends FragmentActivity implements
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						TimerTask not = new TimerTask() {
							...
							private boolean launchNotification() {
								...
								return AuricAccessibilityService
										.hasAccessibilityService(recorder)
										&& !AuricAccessibilityService
	...
	private boolean accessibilityServiceEnabled() {
		...
		if (AuricAccessibilityService.hasAccessibilityService(recorder)) {
			return AuricAccessibilityService.accessibilityServiceEnabled(this);
		}
