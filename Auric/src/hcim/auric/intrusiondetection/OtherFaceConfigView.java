...
public class OtherFaceConfigView extends Activity {
...
//		actionBar.hide();
		...
		setContentView(R.layout.neg_pic_config);

		Button myPicture = (Button) findViewById(R.id.change_picture_button);
		img = (ImageView) findViewById(R.id.image_view);

		Bitmap bitmap = null;
		Picture p = ConfigurationDatabase.getNegativePicture();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
			...
			String name = ConfigurationDatabase.NEGATIVE_PICTURE_ID;
			...
			if (result) {
				...
				Picture p = new Picture(
						ConfigurationDatabase.NEGATIVE_PICTURE_ID, imageBitmap);
				ConfigurationDatabase.setNegativePicture(p);
