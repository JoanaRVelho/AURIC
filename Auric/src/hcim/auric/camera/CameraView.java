 ...
 */
public class CameraView extends CameraBridgeViewBase implements PreviewCallback {
		...
		synchronized (this) {
			...
			try {
				...
				if (sizes != null) {
					...
					android.hardware.Camera.Size thesize = sizes.get(0);
					Size frameSize = new Size(thesize.width, thesize.height);
	...
	private class JavaCameraFrame implements CvCameraViewFrame {
		...
		public Mat rgba() {
			Imgproc.cvtColor(mYuvFrameData, mRgba, Imgproc.COLOR_YUV2RGBA_NV21,
					4);
			return mRgba;
		}
